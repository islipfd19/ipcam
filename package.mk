...
PKG_SECTION="tools"
PKG_SHORTDESC="IPCam Addon for LibreELEC"
PKG_LONGDESC="IPCam Addon for LibreELEC"
#PKG_AUTORECONF="no"
...
#    cp -PR $ROOT/$PKG_BUILD/* $ADDON_BUILD/$PKG_ADDON_ID

mkdir -p $ADDON_BUILD/$PKG_ADDON_ID
cp $PKG_BUILD/.$TARGET_NAME/tools/ipcam \
$ADDON_BUILD/$PKG_ADDON_ID/
    # let's use our addon.xml instead
#    rm $ADDON_BUILD/$PKG_ADDON_ID/addon.xml

#  mkdir -p $ADDON_BUILD/$PKG_ADDON_ID/bin
#    cp -P $(get_build_dir ipcam)/.$TARGET_NAME/ipcam $ADDON_BUILD/$PKG_ADDON_ID/bin

#  mkdir -p $ADDON_BUILD/$PKG_ADDON_ID/lib
#    cp -P $(get_build_dir ipcam)/.$TARGET_NAME/libgamestream/libgamestream.so* $ADDON_BUILD/$PKG_A$
#    cp -P $(get_build_dir ipcam)/.$TARGET_NAME/libgamestream/libmoonlight-common.so* $ADDON_BUILD/$
